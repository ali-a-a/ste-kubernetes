...
<div align="center">
  <a href="https://github.com/othneildrew/Best-README-Template">
    <img src="https://github.com/user-attachments/assets/1acd6691-ea28-4a25-99a9-3d9f60b34a40" alt="Logo" width="189" height="160">
  </a>

  <h1 align="center">Fast Container Orchestration for Dynamic and Ephemeral Workloads</h1>
  <p align="center">
...
specify the path on your machines that this github repository is located in by changing the `ste_dir` variable in the `group_vars/all.yaml`
file. Use this command to start the installation using ansible:
